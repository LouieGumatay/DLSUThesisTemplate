...
\newcommand{\examinerA}{Jay Robert del Rosario}

\newcommand{\examinerBTitle}{Dr.} 
\newcommand{\examinerB}{Roderick Yap}
...
\newcommand{\groupID}{Ariba} % group ID number is for undergraduates as of this formatting
...
\defineAuthor{surname1}{Azarraga}
\defineAuthor{firstname1}{Ejnar Jaye C.}

\defineAuthor{surname2}{Chiu}
\defineAuthor{firstname2}{Marc Janssen C.}

\defineAuthor{surname3}{Gumatay}
\defineAuthor{firstname3}{Louie Bonifacio}

\newcommand{\documentTitle}{Cognitive Rehabilitation for Hand injured people using Android App} % put tilde (~) between words to indicate non-breaking adjacent words
